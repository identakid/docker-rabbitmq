...
To create the image `identakid/rabbitmq`, execute the following command on the identakid-rabbitmq folder:

	sudo docker build -t identakid/rabbitmq .
...
Run the following command to start rabbitmq:
	...
	docker run -d -p 5672:5672 -p 15672:15672 identakid/rabbitmq
...
set the environment variable `RABBITMQ_PASS` to your specific password when running the container:
	...
	docker run -d -p 5672:5672 -p 15672:15672 -e RABBITMQ_PASS="mypass" identakid/rabbitmq
